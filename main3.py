...
class MimosNetwork:
    ...
    # main loop: deadlock -> simulate hyperperiods -> alpha convergence
            ...
            if k >= 2:
                ...
                if diff < eps:
                    return {
                        ...
                        "alpha_hist": alpha_hist,   # full-time alpha traces
                        "x_hist": x_hist,
                        "q_hist": q_hist,
                        "eps": eps,
                        "max_diff": diff,
...
def example1():
    ...
    # edges: id, source, target, A_p, U_p, W_p
    net.add_edge(Edge(id=0, source=0, target=1, U_p=4, W_p=5, A_p=0))
    net.add_edge(Edge(id=1, source=1, target=2, U_p=5, W_p=7, A_p=0))
    net.add_edge(Edge(id=2, source=2, target=0, U_p=7, W_p=3, A_p=21))
